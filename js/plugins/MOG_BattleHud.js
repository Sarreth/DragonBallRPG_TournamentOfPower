...
Battle_Hud.prototype.create_face = function() {
	...
	if (!this._battler) {return};
	var btmp = Battle_Hud.drawFace(this._battler._faceName, this._battler._faceIndex);
	this._face = new Sprite(btmp);
...
Battle_Hud.drawFace = function(faceName, faceIndex) {
    ...
    result.blt(bitmap, sx, sy, sw, sh, dx, dy);
	return result;
};	
